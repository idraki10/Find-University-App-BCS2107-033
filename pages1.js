...
function getAll(){
    ...
    axios.get(`http://universities.hipolabs.com/search?name=${inputValue}`)
        ...
        if(results.length) { 
            ...
            html += `
            <div>
              <h4 class="school-name">University name:${element.name}</h4>
              <p class="school-country">Country:${element.country}</p> 
        ...
        displayUniversities.innerHTML = html;  
            ...
            <div>
                ...
                <h4 class="oops">Oops! <br>Sorry the word you requested is not found</h4>
            </div>
            `;
